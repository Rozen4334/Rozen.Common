...
{
    /// <summary>
    ///     Represents a container that parses emojis from name values.
    /// </summary>
    public static class EmojiNameContainer
    {
        private static readonly IReadOnlyDictionary<string, string> _nameUnicodeContainer = Populate();

        /// <summary>
        ///     Tries to get the unicode value for provided name.
        /// </summary>
        /// <param name="name">The name of the emoji.</param>
        /// <param name="unicode">The unicode representation of provided name.</param>
        /// <returns>True if succesful. False if not.</returns>
        public static bool TryGetCode(string name, out string? unicode)
        {
            if (_nameUnicodeContainer.TryGetValue(name, out unicode))
                return true;
            return false;
        }

        /// <summary>
        ///     Tries to get the <see cref="LocalEmoji"/> for provided name.
        /// </summary>
        /// <param name="name">The name of the emoji.</param>
        /// <param name="emoji">The succesfully parsed value.</param>
        /// <returns>True if succesful. False if not.</returns>
        public static bool TryGetEmoji(string name, out LocalEmoji? emoji)
        {
            emoji = null;
            if (TryGetCode(name, out var value))
            {
        ...
        /// <summary>
        ///     Gets the unicode value for provided name.
        /// </summary>
        /// <param name="name">The name of the emoji.</param>
        /// <returns>The emoji unicode representation.</returns>
        public static string GetUnicode(string name)
            => _nameUnicodeContainer[name];

        /// <summary>
        ///     Gets the <see cref="LocalEmoji"/> for provided name.
        /// </summary>
        /// <param name="name">The name of the emoji.</param>
        /// <returns>The <see cref="LocalEmoji"/> representation.</returns>
        ...
        private static IReadOnlyDictionary<string, string> Populate()
        {
